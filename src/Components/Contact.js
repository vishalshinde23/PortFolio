...
function Contact() {
 ...
 useEffect(()=>{
  ...
  return (
    <section  name="contact" class=" h-[980px]  mt-[50px]   md:mt-[-270px]    dark:bg-gray-900">
    <div  class="flex flex-col items-center justify-center gap-6 px-6   mx-auto md:h-full lg:py-0">
        ...
        <div smooth duration={500} data-aos="fade-up" data-aos-delay="500" data-aos-duration="500" class="w-full bg-black outline-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div smooth duration={500} data-aos="fade-up" data-aos-delay="500" data-aos-duration="500" class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#" onSubmit={onSubmit}>
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" value={message} placeholder="my message" onChange={handleChange} class="bg-blue-900 outline-white  resize-none h-[150px] border   border-gray-300 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                    </div>
